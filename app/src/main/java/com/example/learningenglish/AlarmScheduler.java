...
public class AlarmScheduler {
    private static final int NOTIFICATION_ID = 5123;
    public static void startNotifications(Context context){
        // Получаем доступ к службе оповещения
        SharedPreferences prefs = context.getSharedPreferences("LearningEnglish", MODE_PRIVATE);
        int intervalMillis = prefs.getInt("intervalMillis", 10000);
        boolean mode = prefs.getBoolean("mode", false);
